      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
            ...
            <p class="mt-2 text-slate-300 text-lg font-light">
                Prêt à élever vos standards ? Voici votre tableau de bord.
            </p>
        </div>
      ...
      <div class="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl p-8 shadow-2xl group transition-all hover:border-[#D4AF37]/30">
          ...
          <div class="relative z-10">
              <div class="flex items-center gap-3 mb-4">
                  ...
                  <h3 class="text-sm font-bold text-[#D4AF37] uppercase tracking-widest">Recommandation Stratégique</h3>
              </div>
              
              <h2 class="text-3xl font-bold text-white mb-4">
                  Objectif : Plan <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-amber-200">{{ reportData().recommendedPlan }}</span>
              </h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-8 shadow-xl hover:bg-white/10 transition-colors duration-300">
          <div class="flex items-center mb-6">
              ...
              <h3 class="text-xl font-bold text-white">Vos Atouts Majeurs</h3>
          </div>
          <ul class="space-y-4">
        ...
        <div class="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-8 shadow-xl hover:bg-white/10 transition-colors duration-300">
          <div class="flex items-center mb-6">
              ...
              <h3 class="text-xl font-bold text-white">Opportunités de Croissance</h3>
          </div>
          <ul class="space-y-4">
