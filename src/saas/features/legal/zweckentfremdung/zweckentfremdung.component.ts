       ...
       <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0">
           ...
           <div class="bg-slate-800 rounded-xl border border-white/10 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <button class="w-full py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-lg shadow-lg shadow-indigo-500/20" data-debug-id="zweck-check-btn">
                        Check Permissions
                    </button>
                    ...
                    @if (tier() === 'TIER_3') {
                        <div class="pt-4 border-t border-white/10 mt-4">
                            ...
                            <p class="text-xs text-slate-400 mb-3">Generate a compliant "Antrag auf Genehmigung" (Permit Application).</p>
                             <button class="w-full py-2 bg-slate-700 hover:bg-slate-600 text-white text-xs font-bold rounded flex items-center justify-center gap-2" data-debug-id="zweck-draft-pdf-btn">
